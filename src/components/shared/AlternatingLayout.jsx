      ...
      <div
        ...
        style={{
          background: textOnLeft
            ? 'linear-gradient(to right, rgba(0, 0, 0, 0.98) 0%, rgba(0, 0, 0, 0.90) 25%, rgba(0, 0, 0, 0.50) 50%)'
            : 'linear-gradient(to left, rgba(0, 0, 0, 0.98) 0%, rgba(0, 0, 0, 0.90) 25%, rgba(0, 0, 0, 0.50) 50%)'
        }}
      />

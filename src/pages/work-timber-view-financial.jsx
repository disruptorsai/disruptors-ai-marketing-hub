...
const caseData = {
  ...
  clientLogo: "https://ulfnzcniivkjtfaoxfmi.supabase.co/storage/v1/object/public/site-images/case-studies/logos/timberviewfinancial-logo.webp",
...
export default function WorkTimberViewFinancial() {
  usePageMeta({
    ...
    jsonLd: [
      breadcrumb('Timberview Capital Case Study', '/work-timber-view-financial'),
      {

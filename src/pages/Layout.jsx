        ...
        <div className="relative z-10 min-h-screen">
          ...
          {!showPresentationMode && (
            <button
              ...
              className="fixed bottom-6 right-6 z-50 bg-[#FFD700] text-black px-4 py-3 rounded-lg shadow-lg hover:bg-[#FFD700]/90 transition-all duration-300 flex items-center gap-2 font-supply font-bold text-sm uppercase tracking-wider"

...
const caseData = {
  ...
  clientLogo: "https://ulfnzcniivkjtfaoxfmi.supabase.co/storage/v1/object/public/site-images/case-studies/logos/neuromastery-logo.webp",
...
export default function WorkNeuroMastery() {
  usePageMeta({
    ...
    jsonLd: [
      breadcrumb('Neuro Mastery Case Study', '/work-neuro-mastery'),
      {

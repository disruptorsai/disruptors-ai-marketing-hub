...
export function buildOpportunityPrompt(profile: any, readinessScore: number): string {
  return `
BUSINESS CONTEXT:
...
export function buildServiceMappingPrompt(opportunities: any[], selectedIds: string[]): string {
...
export function buildCopyPrompt(profile: any, opportunities: any[], tone: string = 'professional'): string {
  return `
BUSINESS PROFILE:
${JSON.stringify(profile, null, 2)}
